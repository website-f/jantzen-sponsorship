...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sponsorships', function (Blueprint $table) {
            ...
            $table->enum('status', ['none','submit', 'approval', 'reject', 'proof', 'collect', 'collected', 'complete', 'blacklist'])->default('none');
            $table->enum('states', ['Processing','Pending', 'Collected', 'MIA', 'Completed', 'Rejected', 'Blacklist'])->default('Processing');
