  ...
  <div class="mb-9">
    <div id="projectSummary" data-list='{"valueNames":["projectName","assignees","start","deadline","task","projectprogress","status","action"],"page":6,"pagination":true}'>
      <div class="row mb-4 gx-6 gy-3 align-items-center">
        <div class="col-auto">
          <h2 class="mb-0">New Requests<span class="fw-normal text-body-tertiary ms-3">({{$newCount}})</span></h2>
        </div>
        ...
        <table class="table fs-9 mb-0 border-top border-translucent">
          ...
          <tbody class="list" id="project-list-table-body">
            ...
            <tr class="position-static">
                              ...
                              <div class="row g-0">
                                <div class="col-6 col-xl-3">
                                  <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end border-translucent">
                                    ...
                                    <h3 class="fw-semibold ms-xl-3 ms-xxl-0 pe-md-2 pe-xxl-0 mb-0 mb-sm-3">{{$item->ro_200ml}}</h3>
                                  </div>
                                </div>
                                <div class="col-6 col-xl-3">
                                  <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end-md-0 border-end-xl border-translucent">
                                    ...
                                    <h3 class="fw-semibold ms-xl-3 ms-xxl-0 pe-md-2 pe-xxl-0 mb-0 mb-sm-3">{{$item->ro_500ml}}</h3>
                                  </div>
                                </div>
                                <div class="col-6 col-xl-3">
                                  <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end-md-0 border-end-xl border-translucent">
                                    ...
                                    <h3 class="fw-semibold ms-xl-3 ms-xxl-0 pe-md-2 pe-xxl-0 mb-0 mb-sm-3">{{$item->ro_350ml}}</h3>
                                  </div>
                                </div>
                                <div class="col-6 col-xl-3">
                                  <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end-md-0 border-end-xl border-translucent">
                                    ...
                                    <h3 class="fw-semibold ms-xl-3 ms-xxl-0 pe-md-2 pe-xxl-0 mb-0 mb-sm-3">{{$item->ro_11L}}</h3>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-12 col-xxl-4">
                          <div class="bg-light dark__bg-gray-1100 h-100">
                            <div class="p-4 p-lg-6">
                              <h3 class="text-body-highlight mb-4 fw-bold">Approval</h3>
                              <form action="/approve-new-requests/{{$item->id}}" method="POST">
                                @csrf
                                @method('PUT')
                              <div class="form-floating my-3">
                                <select class="form-select" id="floatingSelect" name="handle_by" aria-label="Floating label select example">
                                  <option selected="">Select...</option>
                                  @foreach ($allUser as $user)
                                    <option value="{{$user->name}}">{{$user->name}}</option>
                                  @endforeach
                                </select>
                                <label for="floatingSelect">Handle By</label>
                              </div>

                              <div class="form-floating my-3">
                                <textarea class="form-control" name="remarks" id="floatingTextarea2" placeholder="Leave a comment here" style="height: 100px"></textarea>
                                <label for="floatingTextarea2">Remarks</label>
                              </div>
                    
                              <h4 class="mt-6 mb-4">Sponsor Products</h4>
                              <label class="mb-1 text-body-highlight" for="balcony">RO 200ml(48 Cups/Carton)</label>
                              <div class="input-group" data-quantity="data-quantity">
                                ...
                                <input class="form-control input-spin-none text-center" id="balcony" name="confirmro_200ml" type="number" value="0" />
                              ...
                              <label class="mb-1 text-body-highlight mt-4" for="balcony">RO 500ml(24 Bottles/Carton)</label>
                              <div class="input-group" data-quantity="data-quantity">
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="minus"><span class="fa-solid fa-minus"></span></button>
                                <input class="form-control input-spin-none text-center" id="balcony" name="confirmro_500ml" type="number" value="0" />
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="plus"><span class="fa-solid fa-plus"></span></button>
                              </div>
                              <label class="mb-1 text-body-highlight mt-4" for="balcony">RO 11L(1 Bottle)</label>
                              <div class="input-group" data-quantity="data-quantity">
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="minus"><span class="fa-solid fa-minus"></span></button>
                                <input class="form-control input-spin-none text-center" id="balcony" name="confirmro_11L" type="number" value="0" />
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="plus"><span class="fa-solid fa-plus"></span></button>
                              </div>
                              <label class="mb-1 text-body-highlight mt-4" for="balcony">Mineral 350ml(24 Bottles/Carton)</label>
                              <div class="input-group" data-quantity="data-quantity">
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="minus"><span class="fa-solid fa-minus"></span></button>
                                <input class="form-control input-spin-none text-center" id="balcony" name="confirmro_350ml" type="number" value="0" />
                                <button type="button" class="btn border px-3 bg-body-emphasis bg-body-hover lh-1" data-type="plus"><span class="fa-solid fa-plus"></span></button>
                              </div>

                              <div class="form-floating my-3 mt-4">
                                <textarea class="form-control" name="others" id="floatingTextarea2" placeholder="Leave a comment here" style="height: 100px"></textarea>
                                <label for="floatingTextarea2">Others</label>
                              </div>

                              <button class="btn btn-success w-100 mt-5 my-3" type="submit">Approve</button>
                              <a href="/reject/{{$item->id}}" class="btn btn-outline-danger w-100">Reject</a>
                              </form>
                            </div>
              ...
              <td class="align-middle white-space-nowrap task ps-3 py-4">
                <button style="background-color: grey" class="btn">{{$item->states}}</button>
              </td>
              <td class="align-middle white-space-nowrap task ps-3 py-4">
