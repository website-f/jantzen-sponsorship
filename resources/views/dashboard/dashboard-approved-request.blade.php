  ...
  <div class="mb-9">
    <div id="projectSummary" data-list='{"valueNames":["projectName","assignees","start","deadline","task","projectprogress","status","action"],"page":6,"pagination":true}'>
      <div class="row mb-4 gx-6 gy-3 align-items-center">
        <div class="col-auto">
          <h2 class="mb-0">Approved Requests<span class="fw-normal text-body-tertiary ms-3">({{$approvedCount}})</span></h2>
        </div>
        ...
        <table class="table fs-9 mb-0 border-top border-translucent">
          ...
          <tbody class="list" id="project-list-table-body">
            ...
            <tr class="position-static">
              <td class="align-middle white-space-nowrap start ps-3 py-4">{{date('M d, Y', strtotime($item->from_date))}} - <br> {{date('M d, Y', strtotime($item->to_date))}}</td>
                        ...
                        <div class="col-12 col-xxl-4">
                          <div class="bg-light dark__bg-gray-1100 h-100">
                            <div class="p-4 p-lg-6">
                              ...
                              <p>Confirm to give the task ?</p>
                              <form action="/pretask/{{$item->id}}">
                                <div class="form-floating my-3">
                                  <textarea class="form-control" name="tasks" id="floatingTextarea2" placeholder="Leave a comment here" style="height: 100px"></textarea>
                                  <label for="floatingTextarea2">Tasks</label>
                                </div>
                                <button type="submit" class="btn btn-outline-primary">Confirm</button>
                                <a href="/reject/{{$item->id}}" class="btn btn-outline-danger">Reject</a>
                              </form>
                            </div>
              ...
              <td class="align-middle white-space-nowrap task ps-3 py-4">
                <button class="btn btn-success">{{$item->states}}</button>
              </td>
              <td class="align-middle white-space-nowrap task ps-3 py-4">
